...
export const CompanyInfoDrawer: React.FC<CompanyInfoDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:justify-end bg-black/70 p-0 sm:p-4 backdrop-blur-xs animate-in fade-in select-none">
      <div className="flex h-full max-h-screen sm:max-h-[92vh] w-full max-w-2xl flex-col overflow-hidden bg-[#111b21] sm:rounded-3xl shadow-2xl border-0 sm:border border-[#222d34] animate-in slide-in-from-right duration-200 text-slate-100">
        {/* EXECUTIVE HEADER */}
        <div className="relative border-b border-[#222d34] bg-[#111b21] px-6 py-5 text-white shrink-0">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              {companyLogoUrl ? (
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl overflow-hidden border border-[#222d34] bg-[#202c33] shadow-md">
                  <img src={companyLogoUrl} alt="Company Logo" className="h-full w-full object-cover" />
                </div>
              ) : (
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#00a884] text-slate-950 font-black shadow-lg shadow-[#00a884]/20">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#00a884]/20 border border-[#00a884]/30 px-2 py-0.5 text-[10px] font-semibold text-teal-300">
            ...
            <button
              onClick={onClose}
              className="rounded-xl bg-[#202c33] hover:bg-[#2a3942] p-2 text-slate-400 hover:text-white transition cursor-pointer shrink-0"
              title="বন্ধ করুন"
            >
              <X className="h-5 w-5" />
            </button>
          ...
          <div className="mt-5 grid grid-cols-3 gap-1.5 rounded-2xl bg-[#182229] p-1 border border-[#222d34]">
            <button
        ...
        {/* CONTENT BODY */}
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 bg-[#0b141a] text-slate-200 text-sm leading-relaxed space-y-6">
          {/* TAB 1: ABOUT COMPANY */}
          {activeTab === 'about' && (
            <div className="space-y-5 animate-in fade-in">
              {/* Mission Card */}
              <div className="rounded-2xl border border-[#222d34] bg-[#111b21] p-5 shadow-xs">
              ...
              {/* CORE PILLARS */}
              <div className="rounded-2xl border border-[#222d34] bg-[#111b21] p-5 shadow-sm space-y-3">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    <div className="h-5 w-5 rounded-md bg-[#00a884]/20 text-[#00a884] flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs">
                      ১
                    </div>
                    <div>
                      <div className="text-xs font-bold text-slate-100">সরকারি সনদ ও অনুমোদন সাপেক্ষে পরিচালিত</div>
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-100">হাতে-কলমে কাজের অভিজ্ঞতা</div>
                      <div className="text-xs text-slate-300 mt-0.5">
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-100">উন্মুক্ত কাজের সুযোগ</div>
                      <div className="text-xs text-slate-300 mt-0.5">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-[#111b21] via-[#1a2830] to-[#0d1e1c] p-5 text-white shadow-lg border border-[#00a884]/30">
                <div className="flex items-start gap-3.5">
                  <div className="h-10 w-10 rounded-xl bg-[#00a884]/20 text-[#00a884] border border-[#00a884]/40 flex items-center justify-center shrink-0">
                ...
                {onOpenCounselorChat && (
                  <button
                    ...
                    className="mt-4 w-full flex items-center justify-center gap-2 rounded-xl bg-[#00a884] hover:bg-[#00c298] text-slate-950 py-2.5 px-4 text-xs font-bold transition shadow-xs cursor-pointer active:scale-[0.98]"
                  >
          ...
          {activeTab === 'benefits' && (
            <div className="space-y-5 animate-in fade-in">
              {/* Courses Advantages */}
              <div className="rounded-2xl border border-[#222d34] bg-[#111b21] p-5 shadow-sm space-y-3.5">
                <div className="flex items-center gap-2 text-[#00a884] font-bold text-xs uppercase tracking-wider">
                  <BookOpen className="h-4 w-4 text-[#00a884]" />
                  <span>কোর্সের প্রধান সুবিধাসমূহ</span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
              ...
              <div className="rounded-2xl border border-[#222d34] bg-[#111b21] p-5 shadow-sm space-y-3.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-[#00a884] font-bold text-xs uppercase tracking-wider">
                    <Headphones className="h-4 w-4 text-[#00a884]" />
                    <span>৩ স্তরের ডেডিকেটেড সাপোর্ট সিস্টেম</span>
                  </div>
                  <span className="text-[10px] font-semibold text-[#00a884] bg-[#00a884]/15 px-2 py-0.5 rounded-full border border-[#00a884]/30">
                    সার্বক্ষণিক সক্রিয়
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  {/* Level 1: Trainer */}
                  <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    <div className="h-9 w-9 rounded-xl bg-[#00a884] text-slate-950 flex items-center justify-center font-bold text-xs shrink-0 shadow-xs">
                      ১
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-slate-100">Trainer (প্রশিক্ষক)</span>
                        <span className="text-[10px] font-medium text-[#00a884]">স্কিল মেন্টরিং</span>
                      </div>
                  ...
                  <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-slate-100">Team Leader (টিম লিডার)</span>
                        <span className="text-[10px] font-medium text-[#00a884]">অগ্রগতি তদারকি</span>
                      </div>
                      <p className="text-xs text-slate-300 mt-0.5">
                  ...
                  <div className="flex items-start gap-3.5 p-3.5 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-slate-100">Live Support Team (লাইভ সাপোর্ট)</span>
                        <span className="text-[10px] font-medium text-[#00a884]">তাৎক্ষণিক সমাধান</span>
                      </div>
                      <p className="text-xs text-slate-300 mt-0.5">
          ...
          {activeTab === 'terms' && (
            <div className="space-y-4 animate-in fade-in">
              <div className="rounded-2xl border border-[#222d34] bg-[#111b21] p-5 shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs text-slate-300">
                  {/* Rule 1 */}
                  <div className="p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60 space-y-1">
                    <div className="font-bold text-slate-100 flex items-center gap-1.5">
                      <span className="text-[#00a884]">১.</span>
                  ...
                  <div className="p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60 space-y-1">
                    <div className="font-bold text-slate-100 flex items-center gap-1.5">
                      <span className="text-[#00a884]">২.</span>
                  ...
                  <div className="p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60 space-y-1">
                    <div className="font-bold text-slate-100 flex items-center gap-1.5">
                      <span className="text-[#00a884]">৩.</span>
                  ...
                  <div className="p-3 rounded-xl bg-[#202c33]/70 border border-[#2a3942]/60 space-y-1">
                    <div className="font-bold text-slate-100 flex items-center gap-1.5">
                      <span className="text-[#00a884]">৪.</span>
        ...
        <div className="border-t border-[#222d34] bg-[#111b21] px-6 py-3.5 flex items-center justify-between gap-4 shrink-0">
          <div className="text-[11px] text-slate-400 font-medium">
            <span className="text-slate-200 font-semibold">Unity Earning</span>
          ...
          <button
            onClick={onClose}
            className="rounded-xl bg-[#202c33] hover:bg-[#2a3942] text-slate-200 px-4 py-2 text-xs font-bold transition cursor-pointer"
          >
            বন্ধ করুন
          </button>
        </div>
